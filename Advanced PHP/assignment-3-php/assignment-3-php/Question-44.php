...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$error) {
        ...
        if (mail($to, $subject, $message, $headers)) {
            echo "<span style='color:green;'>Registration successful! A confirmation email has been sent.</span><br>";
        } else {
            echo "<span style='color:orange;'>Registration successful, but failed to send confirmation email.</span><br>";
        }
    }
}
?>
